...
public class W3RedTie extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;

    public W3RedTie(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("googleNPC/RedTie.png"), 25, 25), "STAND_LEFT");
    }
