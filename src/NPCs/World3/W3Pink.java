...
public class W3Pink extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;

    public W3Pink(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("googleNPC/Pink.png"), 25, 25), "STAND_LEFT");
    }
