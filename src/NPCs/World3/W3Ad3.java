...
public class W3Ad3 extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;

    public W3Ad3(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("Ad-QU.png"), 16, 32), "DEFAULT");
    }
