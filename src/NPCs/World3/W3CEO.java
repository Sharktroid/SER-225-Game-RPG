...
public class W3CEO extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;

    public W3CEO(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("googleNPC/CEO.png"), 25, 25), "STAND_LEFT");
    }
