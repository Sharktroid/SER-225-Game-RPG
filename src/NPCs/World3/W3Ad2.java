...
public class W3Ad2 extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;

    public W3Ad2(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("Ad-CC.png"), 16, 32), "DEFAULT");
    }
