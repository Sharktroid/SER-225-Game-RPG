...
public class W3Ad1 extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;

    public W3Ad1(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("Ad-BK.png"), 16, 32), "DEFAULT");
    }
