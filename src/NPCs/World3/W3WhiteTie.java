...
public class W3WhiteTie extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;

    public W3WhiteTie(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("googleNPC/WhiteTie.png"), 25, 25), "STAND_LEFT");
    }
