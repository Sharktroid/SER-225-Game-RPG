...
public class W3LightBlue extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;

    public W3LightBlue(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("googleNPC/LightBlue.png"), 25, 25), "STAND_LEFT");
    }
