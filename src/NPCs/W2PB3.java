...
public class W2PB3 extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;


    public W2PB3(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("PB3.png"), 28, 90), "STAND_RIGHT");
