...
public class W2WarehouseGuy extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;

    public W2WarehouseGuy(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("safariNPC/Warehouse.png"), 25, 25), "STAND_LEFT");
    }
