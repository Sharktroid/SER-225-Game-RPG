...
public class W2StarbucksEmployee extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;

    public W2StarbucksEmployee(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("safariNPC/Starbucks.png"), 25, 25), "STAND_LEFT");
    }
