...
// This class is for the garfunkle NPC
public class Garfunkle extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;

    // >>> CHANGE SPRITE WIDTH <<<
    public Garfunkle(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("Garfunkle.png"), 30, 47), "STAND_LEFT");
    }
