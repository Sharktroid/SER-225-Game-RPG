...
public class W2PB2 extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;


    public W2PB2(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("PB2.png"), 27, 43), "STAND_RIGHT");
