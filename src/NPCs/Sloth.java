...
// This class is for the Sloth NPC
public class Sloth extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;

    public Sloth(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("Sloth.png"), 24, 24), "STAND_LEFT");
    }
