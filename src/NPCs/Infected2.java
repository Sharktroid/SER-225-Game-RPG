...
// purple
public class Infected2 extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;


    public Infected2(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("Noface6.png"), 25, 25), "STAND_LEFT");
