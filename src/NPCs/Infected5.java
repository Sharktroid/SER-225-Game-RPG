...
// pink
public class Infected5 extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;


    public Infected5(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("Noface2.png"), 25, 25), "STAND_LEFT");
