...
// This class is for the elder NPC
public class Elder extends NPC {
    protected boolean isInteracting = false;
    protected SpriteFont playGame;

    // >>> CHANGE SPRITE WIDTH <<<
    public Elder(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("Elder.png"), 23, 38), "STAND_LEFT");
    }
