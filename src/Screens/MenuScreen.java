...
public class MenuScreen extends Screen {
    ...
    public void initialize() {
        ...
        hubWorld = new SpriteFont("HUB WORLD", 200, 319, "Comic Sans", 30, new Color(49, 207, 240));
        ...
        worldZero = new SpriteFont("WORLD ZERO", 200, 519, "Comic Sans", 30, new Color(49, 207, 240));
